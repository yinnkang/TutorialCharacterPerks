...
- TutorialCharacterPerksConfig.cs: Example of ModConfig for custom mod settings;
- TutorialCharacterPerksGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- TutorialCharacterPerksMain.cs: Main mod class, recieves mod management and general events;
- TutorialCharacterPerksTactical.cs: Example of ModTactical for modifying tactical level;
