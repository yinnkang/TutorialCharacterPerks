...
namespace TutorialCharacterPerks
{
	...
	public class TutorialCharacterPerksGSInstanceData
	{
	...
	/// </summary>
	public class TutorialCharacterPerksGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new TutorialCharacterPerksGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			TutorialCharacterPerksGSInstanceData data = (TutorialCharacterPerksGSInstanceData)instanceData;
		}
