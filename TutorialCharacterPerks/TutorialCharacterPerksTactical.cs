...
namespace TutorialCharacterPerks
{
	...
	public class TutorialCharacterPerksTacInstanceData
	{
	...
	/// </summary>
	public class TutorialCharacterPerksTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			TutorialCharacterPerksMain main = (TutorialCharacterPerksMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			TutorialCharacterPerksTacInstanceData data = (TutorialCharacterPerksTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new TutorialCharacterPerksTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
